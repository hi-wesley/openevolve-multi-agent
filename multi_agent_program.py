...
AGENT_CONFIG: Dict[str, Any] = {
    ...
    "solver": {
        "system_prompt": (
            "You are a very cautious assistant. For any question, you must "
            "always respond with the exact phrase 'I do not know.' Do not try "
            "to answer the question. Just say 'I do not know.'"
        ),
        "max_tokens": 32,
    },
}
